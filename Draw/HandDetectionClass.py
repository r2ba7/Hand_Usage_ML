...
class HandDetectionClass():
    ...
    def fingers_up(self):
        fingers=[] 
        if self.landmark_list[self.tipsID[0]][1] > self.landmark_list[self.endID[0]][1]:
            fingers.append(1)
        else:
            fingers.append(0)
        for ID in range(1,5):
            if self.landmark_list[self.tipsID[ID]][2] < self.landmark_list[self.endID[ID]][2]:
                fingers.append(1)
            else:
                fingers.append(0)
        return fingers
